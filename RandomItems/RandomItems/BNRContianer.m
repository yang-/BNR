...
{
    NSString *descriptionString = [[NSString alloc] initWithFormat:@"%@ (%@): Worth $%d (Contianer only $%d), recorded on %@. Subitems: %@", self.itemName, self.serialNumber, self.valueInDollars, _valueInDollars, self.dateCreated, self.subitems];
